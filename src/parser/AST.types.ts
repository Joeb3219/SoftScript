...
export type ASTNodeExpressionNonMath = {
    ...
    token: Token;
    value: ASTNodeAssignment | ASTNodeNumber | ASTNodeIdentifier | ASTNodeFunctionCall;
}

export type MathExpressionVariant = 'subtract' | 'add' | 'multiply' | 'divide' | 'power';
...
export type ASTNodeExpression = {
    type: 'expression';
    token: Token;
    value: ASTNodeExpressionMath | ASTNodeExpressionNonMath | ASTNodeReturnExpression;
}
...
export type ASTNodeStatement = {
    type: 'statement';
    token: Token;
    value: ASTNodeFunctionDefinition | ASTNodeExpression | ASTNodeVariableDefinition;
}
